...
class Win1 extends JFrame implements ActionListener // =========== REGISTER AS STUDENT =================//
{
	Container con1= getContentPane();
	JLabel lhead, lname,lemail,lgender,ldob,lpassword,lmob,ltp,lcourse,lsq,sq,sa;
	JTextField tname,temail,tphone,tpass,tsq,tsa;
	JRadioButton r1,r2;
	ButtonGroup gender=new ButtonGroup();
	JCheckBox term;
	JComboBox day,month,year,course,osq,ccode;
	JTextArea display;
	...
	public Win1(){
		...
		lhead=new JLabel("REGISTER AS STUDENT");
		...
		lcourse.setBounds(50,400,200,50);
		lcourse.setForeground(Color.GREEN);
	...
	day =new JComboBox(daylist);
	 ...
	 course.setBounds(120,417,100,25);
	 course.setEditable(true);
		...
		tphone.setBounds(190,315,180,20);
		...
		bc.setBounds(580,470,100,30);
		bc.addActionListener(this);
		//bc.setBackground(Color.black);
		//bc.setForeground(Color.GREEN);
	...
	}// End of Constructor (Win1)

	
	 public void actionPerformed(ActionEvent e)
	 {	String che=e.getActionCommand();
